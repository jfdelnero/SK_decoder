	...
	if(w_io)
	{
		...
		if(w_io->file)
		{
			...
			switch(w_io->type)
			{
				...
				case WAVE_FILE_FORMAT_WAV_8BITS_MONO:    // Wave 8 bits mono
				...
				case WAVE_FILE_FORMAT_WAV_16BITS_MONO:   // Wave 16 bits mono
					...
					if(
                        w_io->type == WAVE_FILE_FORMAT_WAV_16BITS_MONO ||
                        w_io->type == WAVE_FILE_FORMAT_WAV_8BITS_MONO 
                    )
                    {
						wavhdr.NumOfChan = 1;
                    }
					...
					if(w_io->type == WAVE_FILE_FORMAT_WAV_8BITS_STEREO || w_io->type == WAVE_FILE_FORMAT_WAV_8BITS_MONO)
